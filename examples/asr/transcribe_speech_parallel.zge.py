...
from nemo.collections.asr.models import ASRModel, EncDecHybridRNNTCTCModel, EncDecCTCModelBPE
...
def main(cfg: ParallelTranscriptionConfig):
    if cfg.model.endswith(".nemo"):
        ...
        model = EncDecCTCModelBPE.from_pretrained(model_name=cfg.model, map_location="cpu")
